                                ...
                                if (entryPoint.Body.Instructions[i - 2].IsLdcI4())
                                {
                                    if (entryPoint.Body.Instructions[i - 3].IsLdloc())
                                    {
                                        MethodDef decryptMethod =
                                            entryPoint.Body.Instructions[i - 1].Operand as MethodDef;
                                        ...
                                        Local loc2 =
                                            entryPoint.Body.Instructions[i - 3].GetLocal(entryPoint.Body.Variables);
                                        arrayFinder(loc2);
                                        ...
                                        epToken =
                                            ((int)key[0] | (int)key[1] << 8 | (int)key[2] << 16 | (int)key[3] << 24);
